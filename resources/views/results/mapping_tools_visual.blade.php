...
function dashboard(id, fData,bidata,bidatalabels){
	...
	hG.init_stackedbar();
        ...
        function mouseclick(d){  // utility function to be called on mouseclick.
   	    ...
   	    d3.select("#statustext").html("<table><font size=2 face='verdana' color='red'><br></br>Pie chart: </font><font size=2 face='verdana'>"+d[0]+"</font></table>");
    ...
    //var biplot = bidata.map(function(d){return [d.fact.Longitude,d.fact.Latitude];});
    ...
    d3.select(id).append("text").attr("id","statustext").html("<table cellpadding=0 cellspacing=0><tr><td><font size=2 face='verdana' color='red'><br></br>Pie chart: </font><font size=2 face='verdana'>Overall</font></td></table>"); //create text
