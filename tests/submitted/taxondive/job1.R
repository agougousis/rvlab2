library(vegan);
taxdis <- get(load("/home/rvlab/jobs2/demo@gmail.com/job1/taxadis_job1.csv"));
...
save(taxondive, ascii=TRUE, file = "/home/rvlab/jobs2/demo@gmail.com/job1/taxondive.csv");
