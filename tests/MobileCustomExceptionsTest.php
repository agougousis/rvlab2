 ...
 *
 * The same tests as in CustomExceptionstTest are contained here. The only
 * difference is that we mock the is_mobile() function by using an alternative
 * namespaced definition. This should be done before any call to the methods
 * we  need to test. So we keep all the tests that need this mock in this class.
 *
 * @author Alexandros Gougousis <gougousis@teemail.gr>
 */
class MobileCustomExceptionstTest extends CommonTestBase
{
